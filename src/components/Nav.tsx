    ...
    >
      ...
      {!isTabletOrMobile && (
        <div className="text-[#FFFFFFFF] flex items-center space-x-16 rounded-md">
          <Link className="rounded-md border-4 border-sky-700 bg-sky-700" to="work" activeClass="active" smooth duration={200}> Proyectos</Link>
          ...
          <Link className="rounded-md border-4 border-sky-700 bg-sky-700" to="contact" activeClass="active" smooth duration={200}>Contacto</Link>
        </div>
      )}
      <AnimatePresence>
